...
export const LEVELS = [
  ...
  // ── L15: 6×6 expert — 5 dead zones ──────────────────────────────────────
  {
    id:15, cols:6, rows:6, targetMoves:14, maxMoves:36, deadZones:[[0,1],[2,2],[3,5],[5,3]],
    conduits:[
      ...
      { id:'c6', color:'#f97316', axis:'V', headRow:1, headCol:1, length:2 },
      { id:'c7', color:'#06b6d4', axis:'H', headRow:5, headCol:0, length:2 },
